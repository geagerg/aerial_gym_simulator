...
if __name__ == "__main__":
    ...
    env_manager = SimBuilder().build_env(
        sim_name="base_sim",
        env_name="env_with_obstacles",  # "forest_env", #"empty_env", # empty_env # env_with_obstacles
    ...
    for i in range(101):
        if i % 100 == 0 and i > 0:
            ...
            # rgb_frames[0].save(f"rgb_frame_{i}.png")
        ...
        try:
            ...
            # rgb_image1 = env_manager.global_tensor_dict["rgb_pixels"][0, 0].cpu().numpy().astype(np.uint8)
        ...
        # rgb_frames.append(Image.fromarray(rgb_image1))
